...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./plugin */ "./src/plugin.ts"));
__export(__webpack_require__(/*! ./version */ "./src/version.ts"));
__export(__webpack_require__(/*! ./widget */ "./src/widget.ts"));
__export(__webpack_require__(/*! ./turtlewidget */ "./src/turtlewidget.js"));
...
Object.defineProperty(exports, "__esModule", { value: true });
var base_1 = __webpack_require__(/*! @jupyter-widgets/base */ "@jupyter-widgets/base");
var widget_1 = __webpack_require__(/*! ./widget */ "./src/widget.ts");
var version_1 = __webpack_require__(/*! ./version */ "./src/version.ts");
var EXTENSION_ID = 'jupyter-pyturtle:main';
/**
 * The example plugin.
 */
var turtlePlugin = {
...
function activateWidgetExtension(app, registry) {
    registry.registerWidget({
        name: 'jupyter-pyturtle',
        version: version_1.EXTENSION_SPEC_VERSION,
        exports: {
            TurtleModel: widget_1.TurtleModel,
            NewTurtleView: widget_1.NewTurtleView
        }
    });
}
...
var base_1 = __webpack_require__(/*! @jupyter-widgets/base */ "@jupyter-widgets/base");
var version_1 = __webpack_require__(/*! ./version */ "./src/version.ts");
var paper_1 = __webpack_require__(/*! paper */ "./node_modules/paper/dist/paper-full.js");
var TurtleModel = /** @class */ (function (_super) {
    __extends(TurtleModel, _super);
    function TurtleModel() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TurtleModel.prototype.defaults = function () {
        return __assign({}, _super.prototype.defaults.call(this), { _model_name: TurtleModel.model_name, _model_module: TurtleModel.model_module, _model_module_version: TurtleModel.model_module_version, _view_name: TurtleModel.view_name, _view_module: TurtleModel.view_module, _view_module_version: TurtleModel.view_module_version, value: 'Hello Turtle' });
    };
    TurtleModel.serializers = __assign({}, base_1.DOMWidgetModel.serializers);
    TurtleModel.model_name = 'TurtleModel';
    TurtleModel.model_module = 'jupyter-pyturtle';
    TurtleModel.model_module_version = version_1.EXTENSION_SPEC_VERSION;
    TurtleModel.view_name = 'NewTurtleView'; // Set to null if no view
    TurtleModel.view_module = 'jupyter-pyturtle'; // Set to null if no view
    TurtleModel.view_module_version = version_1.EXTENSION_SPEC_VERSION;
    return TurtleModel;
}(base_1.DOMWidgetModel));
exports.TurtleModel = TurtleModel;
var NewTurtleDrawing = /** @class */ (function () {
    function NewTurtleDrawing(canvas_element, grid_button, help_button) {
        this.canvas = canvas_element;
        this.canvas.style.background = '#99CCFF';
        paper_1.setup(this.canvas);
        /* adds grid for user to turn off / on, helps see what the turtle is doing */
        this.grid = new paper_1.Path();
        this.grid_on = false;
        this.grid_button = grid_button;
        var that = this;
        this.grid_button.click(function () {
            ...
            if (!that.grid_on) {
                that.grid_on = true;
                grid.strokeColor = 'grey';
                var start = new paper_1.Point(1, 1);
                grid.moveTo(start);
                var canvasSize = that.canvas.width;
                grid.lineTo(start.add([0, canvasSize]));
                var i;
        ...
        this.count = 0;
        this.changRot = 0;
        this.path = new paper_1.Path();
        this.path.strokeWidth = 3;
        this.path.add(new paper_1.Point(this.veryOldX, this.veryOldY));
        // draw the turtle!!!
        this.draw_turtle();
        paper_1.view.on('frame', this.update_turtle);
    }
    NewTurtleDrawing.prototype.nextCount = function () {
        var count = this.count;
        if (count + 1 >= this.points.length) {
            return;
        }
        ...
        if (this.newPen != this.oldPen || this.newColour != this.oldColour) {
            ...
            this.path = new paper_1.Path();
            this.path.strokeWidth = 3;
            this.path.add(new paper_1.Point(this.oldX, this.oldY));
        }
        // Good test command to see what the input is from the string
        //alert("old:"+oldX +" "+ oldY + " " + oldRotation + " New:" + newX + " " +newY + " " + changRot+ " " +turtleSpeed );
    };
    NewTurtleDrawing.prototype.draw_turtle = function () {
        if (this.turtleShow === 1) {
            var oldX = this.oldX;
            var oldY = this.oldY;
            var turtleColour = this.turtleColour;
            var tail = new paper_1.Path.RegularPolygon(new paper_1.Point(oldX - 11, oldY), 3, 3);
            tail.rotate(30);
            tail.fillColor = turtleColour;
            var circlePoint = new paper_1.Point(oldX, oldY);
            var circle1 = new paper_1.Path.Circle(circlePoint, 10);
            circle1.fillColor = turtleColour;
            var circlePoint = new paper_1.Point(oldX + 7, oldY - 10);
            var circle2 = new paper_1.Path.Circle(circlePoint, 3);
            circle2.fillColor = turtleColour;
            var circlePoint = new paper_1.Point(oldX - 7, oldY + 10);
            var circle3 = new paper_1.Path.Circle(circlePoint, 3);
            circle3.fillColor = turtleColour;
            var circlePoint = new paper_1.Point(oldX + 7, oldY + 10);
            var circle4 = new paper_1.Path.Circle(circlePoint, 3);
            circle4.fillColor = turtleColour;
            var circlePoint = new paper_1.Point(oldX - 7, oldY - 10);
            var circle5 = new paper_1.Path.Circle(circlePoint, 3);
            circle5.fillColor = turtleColour;
            var circlePoint = new paper_1.Point(oldX + 10, oldY);
            var circle6 = new paper_1.Path.Circle(circlePoint, 5);
            circle6.fillColor = turtleColour;
            this.turtle = new paper_1.Group([circle1, circle2, circle3, circle4, circle5, circle6, tail]);
        }
    };
    NewTurtleDrawing.prototype.update_turtle = function () {
        var that = this;
        var turtleSpeed = that.turtleSpeed;
        var changRot = that.changRot;
        var turtleShow = that.turtleShow;
        ...
        //rotate turtle, current is the exact centre of the turtle
        if (changRot !== 0 && that.turtleShow === 1) {
            var current = new paper_1.Point(that.oldX, that.oldY);
            if (changRot < 0) {
                // Turning left
                that.changRot += that.rotateSpeed * turtleSpeed;
                that.turtle.rotate(-that.rotateSpeed * turtleSpeed, current);
        ...
        if (that.newY !== that.oldY || that.newX !== that.oldX || that.changRot !== 0) {
            if (that.newPen == 1) {
                that.path.add(new paper_1.Point(that.oldX, that.oldY));
                that.turtle.position = new paper_1.Point(that.oldX, that.oldY);
                that.path.strokeColor = that.newColour;
            }
        }
        else {
            // done animating this command
            that.path.add(new paper_1.Point(that.newX, that.newY));
            that.nextCount();
        }
    };
    return NewTurtleDrawing;
}());
exports.NewTurtleDrawing = NewTurtleDrawing;
var NewTurtleView = /** @class */ (function (_super) {
    __extends(NewTurtleView, _super);
    function NewTurtleView() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NewTurtleView.prototype.render = function () {
        var toinsert = $('<div/>');
        var turtleArea = $('<div/>');
        turtleArea.attr('id', 'turtle-canvas-area');
        toinsert.append(turtleArea);
        ...
        //canvas.resize;
        canvasDiv.append(canvas);
        this.turtledrawing = new NewTurtleDrawing(canvas, gridButton, helpButton);
        this.turtledrawing.points = this.model.get('points');
        this.$el.append(toinsert);
        //window.debugturtle = this;
        this.update();
    ...
    NewTurtleView.prototype.update = function () {
        this.turtledrawing.points = this.model.get('points');
        this.turtledrawing.nextCount();
        this.turtledrawing.update_turtle();
        //this.el.textContent = this.model.get('value');
    };
    return NewTurtleView;
}(base_1.DOMWidgetView));
exports.NewTurtleView = NewTurtleView;
